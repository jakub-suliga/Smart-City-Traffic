...
map_fig.update_layout(
    title="2D Simulationskarte", xaxis_title="X-Achse", yaxis_title="Y-Achse"
)
...
app.layout = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                dcc.Graph(id="map-graph", figure=map_fig, style={"height": "100%"})
            ],
        ),
        ...
        html.Div(
            ...
            children=[
                html.H2("Dashboard"),
                html.Div(
                    "Hier kannst du Einstellungen vornehmen und den Erfolg überwachen."
                ),
